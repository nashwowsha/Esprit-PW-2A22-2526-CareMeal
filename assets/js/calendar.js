...
const CareMealCalendar = {
    ...
    async _loadEvents() {
        ...
        try {
            const res  = await fetch('/Controller/EventController.php', {
                method  : 'POST',
    ...
    _injectStyles() {
        ...
        .inactive-view:hover { color: var(--color-text, #333); border-color: #fe5516 !important; }
        ...
        #calendar-loader {
            ...
            padding: 60px; color: var(--color-text-muted, #64748b); gap: 12px; font-size: 0.95rem;
        }

        /* FullCalendar thème clair */
        #fullcalendar .fc { color: var(--color-text, #333); }
        #fullcalendar .fc-toolbar-title { color: var(--color-text, #333); font-size: 1.1rem; font-weight: 700; }
        #fullcalendar .fc-button {
            background: var(--color-surface, #fff) !important; border-color: var(--color-border, #e2e8f0) !important;
            color: var(--color-text-muted, #64748b) !important; font-size: 0.82rem !important;
            padding: 6px 12px !important; border-radius: 6px !important;
        }
        #fullcalendar .fc-button:hover { background: #f8fafc !important; }
        ...
        #fullcalendar .fc-col-header-cell { background: #f8fafc; }
        #fullcalendar .fc-col-header-cell-cushion { color: var(--color-text-muted, #64748b); font-size: 0.82rem; font-weight: 600; text-decoration: none; }
        #fullcalendar .fc-daygrid-day { background: var(--color-surface, #fff); }
        #fullcalendar .fc-daygrid-day:hover { background: #f1f5f9; }
        #fullcalendar .fc-daygrid-day-number { color: var(--color-text-muted, #64748b); font-size: 0.85rem; text-decoration: none; }
        #fullcalendar .fc-day-today { background: rgba(254,85,22,0.03) !important; }
        #fullcalendar .fc-day-today .fc-daygrid-day-number { color: #fe5516 !important; font-weight: 700; }
        #fullcalendar .fc-scrollgrid { border-color: var(--color-border, #e2e8f0) !important; }
        #fullcalendar .fc-scrollgrid td, #fullcalendar .fc-scrollgrid th { border-color: var(--color-border, #e2e8f0) !important; }
        #fullcalendar .fc-list-day-cushion { background: #f8fafc !important; }
        #fullcalendar .fc-list-event:hover td { background: #f1f5f9 !important; }
        #fullcalendar .fc-list-event-title a { color: var(--color-text, #333) !important; text-decoration: none; }
        #fullcalendar .fc-list-event-time { color: var(--color-text-muted, #64748b) !important; }
        #fullcalendar .fc-timegrid-slot { border-color: var(--color-border, #e2e8f0) !important; }
        #fullcalendar .fc-timegrid-axis { color: var(--color-text-muted, #64748b); font-size: 0.78rem; }
