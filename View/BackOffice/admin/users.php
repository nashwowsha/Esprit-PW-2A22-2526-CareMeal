...
<head>
  ...
  <meta name="description" content="Gestion des utilisateurs CareMeal Ã¯Â¿Â½ Liste, filtre, actions.">
  <title>Gestion Utilisateurs Ã¯Â¿Â½ CareMeal Admin</title>
        ...
        <div class="toolbar animate-fade-in-up">
          <div class="toolbar-left">
            ...
            <div class="filter-group">
              ...
              <button class="filter-btn" data-filter="students" onclick="Admin.filterUsers('students')"><i class="fa-solid fa-graduation-cap"></i> Ã¯Â¿Â½0tudiants</button>
