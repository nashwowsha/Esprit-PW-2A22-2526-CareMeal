    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
          <div class="sidebar-section">
            ...
            <a href="logs.php" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-clipboard-list"></i></span> Logs d'activit�</a>
          </div>
        </nav>
      ...
      <div class="page-content">
        ...
        <div class="grid grid-4 gap-4 mb-8 animate-fade-in-up stagger-1">
          ...
          <div class="stat-card">
            ...
            <div class="stat-change up"><i class="fa-solid fa-arrow-trend-up"></i> +8%</div>
          </div>
          <div class="stat-card">
            ...
            <div class="stat-change up"><i class="fa-solid fa-arrow-trend-up"></i> +23%</div>
          </div>
          <div class="stat-card">
            ...
            <div class="stat-change up"><i class="fa-solid fa-arrow-trend-up"></i> +18%</div>
          </div>
        </div>
        ...
        <div class="grid grid-3 gap-4 mb-8 animate-fade-in-up stagger-2">
          <div class="card" style="display:flex;align-items:center;gap:16px;">
            <div class="stat-icon orange" style="width:48px;height:48px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.3rem;">
          ...
          <div class="card" style="display:flex;align-items:center;gap:16px;">
            <div class="stat-icon yellow" style="width:48px;height:48px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.3rem;">
          ...
          <div class="card" style="display:flex;align-items:center;gap:16px;">
            <div class="stat-icon blue" style="width:48px;height:48px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.3rem;">
        ...
        <div class="grid grid-2 gap-6 animate-fade-in-up stagger-3">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
              <i class="fa-solid fa-user"></i> Derniers inscrits</h3>
              <a href="users.php" class="btn btn-sm btn-outline">Voir tout</a>
            </div>
