    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Vue globale</h2><p>Statistiques et aperÃ§u du systÃ¨me</p></div>
        </div>
      ...
      <div class="page-content">
        ...
        <div class="welcome-banner animate-fade-in-up">
          <div class="welcome-text">
            ...
            <p>Voici un aperÃ§u de l'activitÃ© de la plateforme CareMeal.</p>
          </div>
        ...
        <div class="grid grid-4 gap-4 mb-8 animate-fade-in-up stagger-1">
          ...
          <div class="stat-card">
            ...
            <div class="stat-label">COÃ¯Â¿Â½ Ã©vitÃ©</div>
        ...
        <div class="grid grid-2 gap-6 animate-fade-in-up stagger-3">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa-solid fa-clipboard-list"></i> ActivitÃ© rÃ©cente</h3>
              <a href="events.html" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-calendar-day"></i></span> Ã‰vÃ©nements</a>
