      ...
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title">
            ...
            <p><a href="users.html" style="color:var(--color-primary);">� � Retour à la liste</a></p>
          </div>
        </div>
        ...
        <div class="user-detail-header animate-fade-in-up">
          <div class="user-detail-card">
            ...
            <div>
              ...
              <p style="font-size:0.8rem;color:var(--color-text-muted);margin-top:8px;"><i class="fa-solid fa-calendar"></i> Inscrit le <span id="detail-joined">�</span></p>
            </div>
          </div>
