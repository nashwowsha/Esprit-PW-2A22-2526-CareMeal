...
<head>
  ...
  <meta name="description" content="DÃ©tail d'un utilisateur Ã¯Â¿Â½ CareMeal Admin.">
  <title>Fiche Utilisateur Ã¯Â¿Â½ CareMeal Admin</title>
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="partners.html" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-store"></i></span> Partenaires</a>
                      <a href="events.html" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-calendar-day"></i></span> Ã‰vÃ©nements</a>
      ...
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title">
            ...
            <p><a href="users.html" style="color:var(--color-primary);">Ã¯Â¿Â½ Ã¯Â¿Â½ Retour ÃƒÂ  la liste</a></p>
          </div>
        </div>
      ...
      <div class="page-content">
        ...
        <div class="user-detail-header animate-fade-in-up">
          <div class="user-detail-card">
            ...
            <div>
              <h2 style="margin-bottom:4px;" id="detail-name">Ã¯Â¿Â½</h2>
              <p style="color:var(--color-text-muted);margin-bottom:8px;" id="detail-email">Ã¯Â¿Â½</p>
              <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                <span id="detail-role"></span>
                <span id="detail-status"></span>
              </div>
              <p style="font-size:0.8rem;color:var(--color-text-muted);margin-top:8px;"><i class="fa-solid fa-calendar"></i> Inscrit le <span id="detail-joined">Ã¯Â¿Â½</span></p>
            </div>
          </div>
        ...
        <div class="section animate-fade-in-up stagger-2">
          <h3 style="margin-bottom:20px;"><i class="fa-solid fa-scroll"></i> Historique</h3>
          <div class="card">
