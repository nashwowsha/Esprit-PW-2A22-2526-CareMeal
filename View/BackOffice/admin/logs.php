...
<head>
  ...
  <meta name="description" content="Logs d'activitÃ© Ã¢â‚¬â€ CareMeal Admin.">
  <title>Logs d'activitÃ© Ã¢â‚¬â€ CareMeal Admin</title>
...
<body>
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="partners.html" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-store"></i></span> Partenaires</a>
            ...
            <a href="logs.html" class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-clipboard-list"></i></span> Logs d'activitÃ©</a>
        </div>
      </nav>
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Logs d'activitÃ©</h2><p>Qui a fait quoi, quand</p></div>
        </div>
      ...
      <div class="page-content">
        <div class="card animate-fade-in-up">
          <div class="card-header">
            <h3 class="card-title"><i class="fa-solid fa-clipboard-list"></i> Toute l'activitÃ©</h3>
            <span class="badge badge-info" id="logs-count">0 entrÃ©es</span>
          </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.getElementById('logs-count').textContent = logs.length + ' entrÃ©e' + (logs.length > 1 ? 's' : '');
    });
  </script>
</body>
</html>
