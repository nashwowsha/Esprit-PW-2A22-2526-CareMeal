    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div class="sidebar-footer">
        <div class="sidebar-user">
          ...
          <button class="sidebar-logout" data-action="logout" title="DÃ©connexion">
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Gestion Partenaires</h2><p>Validation et suivi des Ã©tablissements</p></div>
        </div>
        <div class="header-right">
          <a href="/projet2a22/View/FrontOffice/feed.php" title="Fil d'actualité" style="width:40px;height:40px;border-radius:10px;display:flex;align-items:center;justify-content:center;color:var(--color-text-muted);font-size:1.1rem;text-decoration:none;transition:background .15s;" onmouseover="this.style.background='rgba(254,85,22,0.1)';this.style.color='#FE5516'" onmouseout="this.style.background='none';this.style.color='var(--color-text-muted)'">
      ...
      <div class="page-content">
        ...
        <div id="pending-alert" class="animate-fade-in-up" style="display:none;">
          <div class="auth-alert info" style="margin-bottom:24px;">
            <span>
              <span class="input-icon"><i class="fa-solid fa-hourglass-half"></i></span> <span id="pending-count">0</span> partenaire(s) en attente de validation.
          </div>
        </div>
