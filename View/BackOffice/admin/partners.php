...
<head>
  ...
  <meta name="description" content="Gestion des partenaires CareMeal ÃƒÂ¯Ã‚Â¿Ã‚Â½ Validation et suivi.">
  <title>Gestion Partenaires ÃƒÂ¯Ã‚Â¿Ã‚Â½ CareMeal Admin</title>
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Gestion Partenaires</h2><p>Validation et suivi des ÃƒÂ©tablissements</p></div>
        </div>
        ...
        <div class="card animate-fade-in-up stagger-1">
          ...
          <div class="table-container">
            <table class="data-table">
              <thead>
                <tr>
                  <th>ÃƒÂ¯Ã‚Â¿Ã‚Â½Ãƒâ€°tablissement</th>
                  <th>Type</th>
                  <th>Statut</th>
                  <th>Repas sauvÃƒÂ©s</th>
                  <th>Note</th>
                  <th>Actions</th>
                </tr>
              </thead>
