...
<head>
  ...
  <title>Admin Dashboard ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â CareMeal</title>
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="events.html" class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-calendar-day"></i></span> Ãƒâ€°vÃƒÂ©nements</a>
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Gestion des Ãƒâ€°vÃƒÂ©nements</h2><p>Validation et participants</p></div>
        </div>
      ...
      <div class="page-content" id="events-list-view">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px; flex-wrap:wrap; gap:16px;">
            <div class="filters" style="display:flex; gap:8px;">
                ...
                <button class="btn btn-secondary btn-sm" onclick="EventsAdmin.setFilter('validated')"><i class="fa-solid fa-check"></i> ValidÃƒÂ©s (<span id="st-val">0</span>)</button>
                <button class="btn btn-secondary btn-sm" onclick="EventsAdmin.setFilter('completed')"><i class="fa-solid fa-circle-xmark" style="color:var(--color-text-muted)"></i> TerminÃƒÂ©s (<span id="st-comp">0</span>)</button>
            </div>
        ...
        <div class="stats-grid" style="display:flex; gap:16px; margin-bottom:24px;">
          <div class="card" style="flex:1; padding:16px; text-align:center;"><h3 id="stat-total" style="font-size:1.8rem; margin-bottom:4px;">0</h3><span style="font-size:0.85rem; color:var(--color-text-muted);">Total ÃƒÂ©vÃƒÂ©nements</span></div>
          ...
          <div class="card" style="flex:1; padding:16px; text-align:center;"><h3 id="stat-rate" style="color:var(--color-success); font-size:1.8rem; margin-bottom:4px;">0%</h3><span style="font-size:0.85rem; color:var(--color-text-muted);">Taux de prÃƒÂ©sence</span></div>
        </div>
            ...
            <div class="table-container">
                <table style="width:100%; border-collapse:collapse; text-align:left;">
                    <thead style="border-bottom:1px solid var(--color-border); background:rgba(0,0,0,0.2);">
                        <tr>
                            <th style="padding:16px;">Ãƒâ€°vÃƒÂ©nement</th>
                            <th style="padding:16px;">CrÃƒÂ©ateur</th>
