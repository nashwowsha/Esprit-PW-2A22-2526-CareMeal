...
<head>
  ...
  <style>
    ...
    /* Lisibilite (light) : textes/champs visibles */
    .section-card,
    .cat-card,
    .form-card,
    .delete-inline-card,
    ...
    .offers-table tbody tr:hover td { background: #f8fafc !important; }
    .form-card .form-input,
    .form-card .form-textarea {
      background: #ffffff !important;
    ...
    /* Sidebar blanche sur page categorie admin */
    .sidebar,
    .sidebar-header,
    .sidebar-nav,
    .sidebar-footer {
    ...
    <div class="page-content">
      ...
      <div id="view-form">
        ...
        <div id="form-create-wrap" style="display:none;">
          <div class="form-card">
            <form method="POST" action="/admin/categorie.php" id="form-create" novalidate>
        ...
        <div id="form-edit-wrap" style="display:none;">
          <div class="form-card">
            <form method="POST" action="/admin/categorie.php" id="form-edit" novalidate>
  ...
  'form-create': [
    {
      ...
      checks : [
        ...
        { test: function(v){ return !/^[\p{L}0-9 \-'éèêëàâùûüîïôœçÉÈÊËÀÂÙÛÜÎ�?ÔŒÇ]+$/u.test(v.trim()); },
