  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      <div class="sidebar-section">
        ...
        <a href="/caremeal/admin/categories.php" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-tags"></i></span> Catégories &amp; Offres</a>
        <a href="offers.php"                    class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-box"></i></span> Offres (ancien)</a>
