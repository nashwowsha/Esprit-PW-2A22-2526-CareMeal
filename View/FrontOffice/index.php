...
<head>
  ...
  <meta name="description" content="CareMeal â€” Sauvez des repas, faites des Ã©conomies. La plateforme anti-gaspillage alimentaire pour les Ã©tudiants tunisiens.">
  <title>CareMeal â€” Sauvez des repas, faites des Ã©conomies</title>
  ...
  <div class="landing-page">
    ...
    <nav class="landing-nav">
      <a href="index.html" class="landing-logo">
        <div class="landing-logo-icon" style="background: none; box-shadow: none;"><img src="assets/logo.png" alt="Logo" style="max-width: 80px; height: auto;"></div>
        Care<span>Meal</span>
      </a>
      <div class="landing-nav-links">
        <a href="login.html" class="nav-link">Connexion</a>
        <a href="register-student.html" class="btn-nav">S'inscrire</a>
      </div>
    </nav>
    ...
    <section class="landing-hero">
      <div class="hero-content">
        <div class="hero-badge"><i class="fa-solid fa-seedling"></i> Anti-gaspillage alimentaire</div>
        <h1 class="hero-title">
          Sauvez des repas,<br>
          <span class="highlight">faites des Ã©conomies</span>
        </h1>
        <p class="hero-subtitle">
          RÃ©cupÃ©rez des repas invendus ÃƒÂ  prix rÃ©duits prÃ¨s de chez vous. 
          Bon pour votre portefeuille, bon pour la planÃ¨te. <i class="fa-solid fa-earth-africa"></i>
        </p>
        <div class="hero-cta">
          <a href="register-student.html" class="cta-btn primary" id="cta-student">
            <span class="cta-icon"><i class="fa-solid fa-graduation-cap"></i></span>
            Je suis Ã©tudiant
          </a>
          <a href="register-partner.html" class="cta-btn secondary" id="cta-partner">
            <span class="cta-icon"><i class="fa-solid fa-store"></i></span>
            Je suis partenaire
          </a>
        </div>
        ...
        <div class="landing-stats">
          <div class="landing-stat">
            ...
            <div class="landing-stat-label">Repas sauvÃ©s</div>
          </div>
          <div class="landing-stat">
            <div class="landing-stat-value">980 kg</div>
            <div class="landing-stat-label">COÃ¢â€šâ€š Ã©vitÃ©</div>
          </div>
          <div class="landing-stat">
            <div class="landing-stat-value">350+</div>
            <div class="landing-stat-label">Ã‰tudiants actifs</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Admin access -->
    <a href="login.html" class="admin-link" id="admin-access">
