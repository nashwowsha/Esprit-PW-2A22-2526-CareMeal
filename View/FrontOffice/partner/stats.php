      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="offers.php" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-box"></i></span> Mes Offres</a>
            ...
            <a href="stats.html" class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-chart-column"></i></span> Statistiques</a>
      ...
      <div class="page-content">
        ...
        <div class="grid grid-4 gap-4 mb-8 animate-fade-in-up">
          ...
          <div class="stat-card">
            ...
            <div class="stat-change up">—  +20%</div>
          </div>
        </div>
        ...
        <div class="grid grid-3 gap-4 mb-8 animate-fade-in-up stagger-1">
          <div class="card" style="display:flex;align-items:center;gap:16px;">
            <div class="stat-icon blue" style="width:48px;height:48px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.3rem;"><i class="fa-solid fa-message"></i></div>
            <div>
          ...
          <div class="card" style="display:flex;align-items:center;gap:16px;">
            <div class="stat-icon orange" style="width:48px;height:48px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.3rem;"><i class="fa-solid fa-box"></i></div>
            <div>
        ...
        <div class="section animate-fade-in-up stagger-2">
          <div class="section-header">
            <h3><i class="fa-solid fa-message"></i> Derniers avis</h3>
          </div>
          <div class="card">
