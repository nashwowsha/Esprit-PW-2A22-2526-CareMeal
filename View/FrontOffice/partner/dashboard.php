...
<head>
  ...
  <meta name="description" content="Dashboard partenaire CareMeal — Profil éÉtablissement.">
      ...
      <div class="page-content">
        ...
        <div class="profile-header animate-fade-in-up">
          ...
          <div class="profile-info">
            <h2 id="partner-name">Mon Établissement</h2>
            <p class="profile-email" id="partner-email">email@exemple.com</p>
            <div class="profile-meta" style="margin-top:8px;">
              <div class="profile-meta-item"><span><i class="fa-solid fa-store"></i></span> <span id="partner-type">—</span></div>
              <div class="profile-meta-item"><span><i class="fa-solid fa-location-dot"></i></span> <span id="partner-address">—</span></div>
              <div class="profile-meta-item"><span><i class="fa-solid fa-mobile"></i></span> <span id="partner-phone">—</span></div>
            </div>
        ...
        <div class="grid grid-2 gap-6 animate-fade-in-up stagger-2">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa-solid fa-pen-to-square"></i> Description</h3>
            </div>
            <p style="color:var(--color-text);line-height:1.7;" id="partner-description">—</p>
          </div>

          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa-solid fa-clock"></i> Horaires d'ouverture</h3>
            </div>
