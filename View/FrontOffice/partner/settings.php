    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="settings.html" class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-gear"></i></span> Paramètres</a>
        </div>
      </nav>
    ...
    <main class="main-content">
      ...
      <div class="page-content" style="max-width:700px;">
        ...
        <div class="section animate-fade-in-up">
          <h3 style="margin-bottom:20px;"><i class="fa-solid fa-store"></i> Informations de l'établissement</h3>
          <div class="card">
            ...
            <div class="form-group">
              <label for="edit-address">Adresse complète</label>
              <div class="input-wrapper">
        ...
        <div class="section animate-fade-in-up stagger-1">
          ...
          <div class="card">
            ...
            <button class="btn btn-primary" onclick="Partner.updatePassword()" id="btn-update-password">
              <span><i class="fa-solid fa-floppy-disk"></i></span> Mettre à jour
            </button>
          </div>
        </div>
            ...
            <div class="settings-item">
              <div class="settings-item-left">
                ...
                <div class="settings-item-info">
                  ...
                  <p> `tre notifié quand vous recevez un nouvel avis</p>
                </div>
              </div>
              <label class="switch">
                <input type="checkbox" checked>
