...
<head>
  ...
  <meta name="description" content="Paramètres de votre éÉtablissement CareMeal.">
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Paramètres</h2><p>Modifiez les informations de votre éÉtablissement</p></div>
        </div>
      ...
      <div class="page-content" style="max-width:700px;">
        ...
        <div class="section animate-fade-in-up">
          <h3 style="margin-bottom:20px;"><i class="fa-solid fa-shop"></i> Informations de l'éÉtablissement</h3>
          <div class="card">
            <div class="form-group">
              <label for="edit-name">Nom de l'éÉtablissement</label>
              <div class="input-wrapper">
                <input type="text" id="edit-name" class="form-input" placeholder="Nom de l'éÉtablissement">
            ...
            <div class="form-group">
              <label for="edit-description">Description de l'éÉtablissement</label>
              <textarea id="edit-description" class="form-textarea" placeholder="Décrivez votre éÉtablissement..." rows="3"></textarea>
            </div>
