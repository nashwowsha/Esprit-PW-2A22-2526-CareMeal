  ...
  <div class="auth-page">
    ...
    <div class="auth-visual">
      ...
      <div class="auth-visual-content">
        ...
        <p style="font-size:0.9rem;color:rgba(255,255,255,0.8);line-height:1.6;margin:0 0 40px;max-width:260px;margin-left:auto;margin-right:auto;">Reduisez vos pertes, attirez de nouveaux clients et agissez pour la planete.</p>
        <div style="display:flex;flex-direction:column;gap:16px;text-align:left;border-top:1px solid rgba(255,255,255,0.2);padding-top:28px;">
          <div style="display:flex;align-items:center;gap:14px;">
            ...
            <span style="color:rgba(255,255,255,0.9);font-size:0.85rem;font-weight:500;">Reduisez vos invendus de 30-50%</span>
          </div>
          <div style="display:flex;align-items:center;gap:14px;">
            <div style="width:36px;height:36px;background:rgba(255,255,255,0.15);border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fa-solid fa-users" style="color:#fff;font-size:0.9rem;"></i>
            </div>
            <span style="color:rgba(255,255,255,0.9);font-size:0.85rem;font-weight:500;">Touchez des centaines d'etudiants</span>
          </div>
          <div style="display:flex;align-items:center;gap:14px;">
            <div style="width:36px;height:36px;background:rgba(255,255,255,0.15);border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fa-solid fa-trophy" style="color:#fff;font-size:0.9rem;"></i>
            </div>
            <span style="color:rgba(255,255,255,0.9);font-size:0.85rem;font-weight:500;">Gagnez en visibilite et en reputation</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="auth-form-side">
      <div class="auth-form-container">
        <div class="auth-form-header">
          ...
          <p>Remplissez les informations de votre etablissement.</p>
        </div>
          ...
          <div id="step-partner-1" class="form-step active">
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <input type="text" id="partner-name" class="form-input" placeholder="Ex: La Baguette Doree">
              </div>
            ...
            <p style="color:var(--color-primary);font-weight:700;margin-bottom:14px;font-size:0.88rem;">
              <i class="fa-solid fa-user-tie" style="margin-right:8px;"></i>Contact Gerant
            </p>
          ...
          <div id="step-partner-2" class="form-step">
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <input type="password" id="partner-password" class="form-input" placeholder="Minimum 6 caracteres">
            ...
            <div class="form-group">
              ...
              <textarea id="partner-description" class="form-textarea" placeholder="Decrivez votre etablissement en quelques mots..." rows="3"></textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="file-upload" id="logo-upload">
                ...
                <p class="upload-text"><span>Cliquez pour uploader</span> ou glissez-deposez</p>
            ...
            <p style="text-align:center;font-size:0.75rem;color:var(--color-text-muted);margin-top:12px;">
              Votre compte sera valide par un administrateur sous 24-48h.
            </p>
          </div>
        ...
        <div class="auth-footer">
          <p>Deja un compte ? <a href="/projet2a22/View/FrontOffice/login.php">Se connecter</a></p>
          <p style="margin-top:8px;">Vous etes etudiant ? <a href="/projet2a22/View/FrontOffice/register-student.php">Creer un compte etudiant</a></p>
        </div>
      </div>
    </div>
