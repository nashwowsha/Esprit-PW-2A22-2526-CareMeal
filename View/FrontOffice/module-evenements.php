...
<body>
    ...
    <div class="container">
        ...
        <section class="hero" id="hero">
            <div class="hero-emoji"><i class="fa-solid fa-users"></i> </div>
...
1 | Journée Anti-Gaspi <i class="fa-solid fa-user-graduate"></i>  | Présentiel | Campus El Manar | capacité 100 | Planifié | Admin | Validé
2 | Distribution Gratuite à°Ã... ¸± | Présentiel | Campus Manouba | capacité 50 | Planifié | Partenaire | Validé
3 | Conférence Anti-Gaspi <i class="fa-solid fa-laptop-code"></i>  | En ligne | zoom.us/j/123456 | capacité 200 | Terminé | Admin | Validé
...
6 | événement 1 | ETU003 | 2026-04-13 | Inscrit
            ...
            <table>
                ...
                <tbody>
                    <tr><td>Journée Anti-Gaspi <i class="fa-solid fa-user-graduate"></i> </td><td>Présentiel</td><td>ETU001</td><td>Inscrit</td></tr>
                    <tr><td>Journée Anti-Gaspi <i class="fa-solid fa-user-graduate"></i> </td><td>Présentiel</td><td>ETU002</td><td>Inscrit</td></tr>
                    <tr><td>Journée Anti-Gaspi <i class="fa-solid fa-user-graduate"></i> </td><td>Présentiel</td><td>ETU003</td><td>Inscrit</td></tr>
                    <tr><td>Distribution Gratuite à°Ã... ¸±</td><td>Présentiel</td><td>ETU001</td><td>Inscrit</td></tr>
                    <tr><td>Conférence Anti-Gaspi <i class="fa-solid fa-laptop-code"></i> </td><td>En ligne</td><td>ETU003</td><td>Présent</td></tr>
                    <tr><td>Conférence Anti-Gaspi <i class="fa-solid fa-laptop-code"></i> </td><td>En ligne</td><td>ETU002</td><td>Absent</td></tr>
                </tbody>
            </table>
        </section>
...
(<span class="string">'Journée Anti-Gaspi <i class="fa-solid fa-user-graduate"></i> '</span>, <span class="string">'2026-05-10'</span>, <span class="string">'09:00:00'</span>, <span class="string">'12:00:00'</span>, <span class="string">'Présentiel'</span>, <span class="string">'Campus El Manar'</span>, NULL, 100, <span class="string">'Planifié'</span>, <span class="string">'Admin'</span>, 1, <span class="string">'Validé'</span>),
...
(<span class="string">'Conférence Anti-Gaspi <i class="fa-solid fa-laptop-code"></i> '</span>, <span class="string">'2026-03-01'</span>, <span class="string">'18:00:00'</span>, <span class="string">'20:00:00'</span>, <span class="string">'En ligne'</span>, NULL, <span class="string">'zoom.us/j/123456'</span>, 200, <span class="string">'Terminé'</span>, <span class="string">'Admin'</span>, 1, <span class="string">'Validé'</span>),
...
('Journée Anti-Gaspi <i class="fa-solid fa-user-graduate"></i> ', '2026-05-10', '09:00:00', '12:00:00', 'Présentiel', 'Campus El Manar', NULL, 100, 'Planifié', 'Admin', 1, 'Validé'),
('Distribution Gratuite à°Ã... ¸±', '2026-05-12', '12:00:00', '14:00:00', 'Présentiel', 'Campus Manouba', NULL, 50, 'Planifié', 'Partenaire', 5, 'Validé'),
('Conférence Anti-Gaspi <i class="fa-solid fa-laptop-code"></i> ', '2026-03-01', '18:00:00', '20:00:00', 'En ligne', NULL, 'zoom.us/j/123456', 200, 'Terminé', 'Admin', 1, 'Validé'),
