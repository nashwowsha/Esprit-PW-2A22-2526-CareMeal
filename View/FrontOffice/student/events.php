...
<head>
  ...
  <style>
      ...
      .badge { padding: 5px 12px; border-radius: 4px; font-size: 0.75rem; font-weight: bold; color: #1A202C; display: inline-block; text-transform:uppercase; letter-spacing:0.5px;}
      .badge-presentiel { background: #0284c7; }
      .badge-online { background: #7e22ce; }
      .badge-valide { background: #10b981; color: #1A202C;}
      .badge-complet { background: #ef4444; color: #1A202C;}
      ...
      /* Deux assistants cote a cote : chatbot a droite, vocal etudiant decale */
      #chatbot-toggle { right: 24px !important; bottom: 24px !important; }
      #chatbot-window { right: 24px !important; }
      .student-va-fab { right: 96px !important; bottom: 24px !important; }
  </style>
</head>
<body>
      ...
      <div class="page-content">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px; flex-wrap:wrap; gap:16px;">
            ...
            <div style="display:flex; gap:12px; align-items:center;">
                <div style="position:relative;">
                    ...
                    <input type="text" id="searchInput" placeholder="Rechercher par titre ou lieu..." style="padding:10px 10px 10px 35px; border-radius:20px; border:1px solid var(--color-border); background:var(--color-surface); color:#1A202C; width: 250px;">
                </div>
        ...
        <div id="subscribeModal" class="modal-overlay" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.7); z-index:9999; align-items:center; justify-content:center;">
            <div style="background:var(--color-surface); padding:24px; border-radius:12px; width:450px; max-width:90%; position:relative; border: 1px solid var(--color-border); box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
                ...
                <h3 style="color:#1A202C; margin-bottom: 5px; font-size:1.5rem;">Inscription</h3>
                ...
                <form id="subscribeForm" onsubmit="event.preventDefault(); EventsStudent.confirmSubscribe();">
                    ...
                    <div class="form-group" style="margin-bottom:15px;">
                        <label for="subRemarque" style="color:#1A202C; display:block; margin-bottom:8px; font-weight:500;">Motivation / Remarque :</label>
                        <textarea id="subRemarque" rows="4" placeholder="Pourquoi souhaitez-vous participer à cet événement ?..." style="width:100%; padding:12px; border-radius:8px; border:1px solid var(--color-border); background:var(--color-background); color:#1A202C; resize:vertical;"></textarea>
                    </div>
        ...
        <div id="registerModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:10000; align-items:center; justify-content:center; overflow-y:auto; padding:20px; box-sizing:border-box;">
          <div style="background:#FFFFFF; border-radius:16px; width:100%; max-width:540px; margin:auto; position:relative; border:1px solid #334155; box-shadow:0 25px 60px rgba(0,0,0,0.7);">
            ...
            <div style="background:linear-gradient(135deg, #fe5516 0%, #c44010 100%); padding:22px 28px; border-radius:16px 16px 0 0;">
              ...
              <div style="display:flex; align-items:center; gap:14px;">
                <div style="background:rgba(255,255,255,0.2); width:46px; height:46px; border-radius:10px; display:flex; align-items:center; justify-content:center;">
                  <i class="fa-solid fa-user-pen" style="color:#1A202C; font-size:1.2rem;"></i>
                </div>
                <div>
                  <h3 id="regModalTitle" style="color:#1A202C; margin:0; font-size:1.15rem; font-weight:700;">Formulaire d'inscription</h3>
            ...
            <!-- Corps -->
            <div style="padding:26px 28px; background:#FFFFFF; border-radius:0 0 16px 16px;">
              <form id="registerModalForm" onsubmit="event.preventDefault(); EventsStudent.submitRegisterAndSubscribe(event)">
                ...
                <div style="display:flex; gap:12px;">
                  ...
                  <button type="submit" id="regmod-submit" style="flex:2; padding:12px; border-radius:8px; border:none; background:linear-gradient(135deg, #fe5516, #c44010); color:#1A202C; font-size:0.95rem; cursor:pointer; font-weight:700;">
  ...
  <script src="<?= htmlspecialchars(caremeal_path('js/events-student.js'), ENT_QUOTES, 'UTF-8') ?>?v=17"></script>
