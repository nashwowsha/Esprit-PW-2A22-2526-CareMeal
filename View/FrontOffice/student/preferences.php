      ...
      <div class="page-content">
        <div class="card animate-fade-in-up" style="max-width:700px;">
          ...
          <div class="tags-grid" style="margin-bottom:32px;">
            <div class="tag" data-value="halal"><span class="tag-emoji">âËœ ªï ¸ </span> Halal</div>
            <div class="tag" data-value="vegetarien"><span class="tag-emoji"><i class="fa-solid fa-house"></i> </span> Végétarien</div>
            <div class="tag" data-value="vegan"><span class="tag-emoji"><i class="fa-solid fa-house"></i> …' ±</span> Végan</div>
            <div class="tag" data-value="sans-gluten"><span class="tag-emoji"><i class="fa-solid fa-house"></i> …' ¾</span> Sans gluten</div>
            <div class="tag" data-value="bio"><span class="tag-emoji"><i class="fa-solid fa-house"></i> †'</span> Bio</div>
            <div class="tag" data-value="sans-lactose"><span class="tag-emoji"><i class="fa-solid fa-house"></i> €Âº</span> Sans lactose</div>
            <div class="tag" data-value="budget"><span class="tag-emoji"><i class="fa-solid fa-coins"></i></span> Petit budget</div>
            <div class="tag" data-value="equilibre"><span class="tag-emoji">âÅÂ¡-ï ¸ </span> Équilibré</div>
            <div class="tag" data-value="sans-noix"><span class="tag-emoji"><i class="fa-solid fa-house"></i> …"</span> Sans fruits à  coque</div>
            <div class="tag" data-value="faible-sucre"><span class="tag-emoji"><i class="fa-solid fa-house"></i> </span> Faible en sucre</div>
          </div>
          ...
          <div style="margin-bottom:32px;">
            <label for="pref-frequency" style="display:block;font-weight:500;margin-bottom:12px;color:var(--color-white);"><i class="fa-solid fa-house"></i>... Fréquence de commande souhaitée</label>
          ...
          <button class="btn btn-primary btn-lg" onclick="Student.savePreferences()" id="btn-save-prefs">
            <span><i class="fa-solid fa-house"></i> </span> Sauvegarder mes préférences
          </button>
        </div>
      </div>
    </main>
