...
<head>
  ...
  <meta name="description" content="Vos points de fidÃƒÆ’Ã‚Â©litÃƒÆ’Ã‚Â© et rÃƒÆ’Ã‚Â©compenses CareMeal.">
  <title>Mes Points Ã¢Ã¢â€šÂ¬Ã¢â‚¬Â CareMeal</title>
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="points.html" class="sidebar-link active"><span class="link-icon">Ã¢Ã‚Â­Ã‚Â</span> Mes Points</a>
        </div>
        <div class="sidebar-section">
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Mes Points</h2><p>Programme de fidÃƒÆ’Ã‚Â©litÃƒÆ’Ã‚Â©</p></div>
        </div>
      ...
      <div class="page-content">
        ...
        <div class="card animate-fade-in-up" style="text-align:center;padding:48px;margin-bottom:32px;position:relative;overflow:hidden;">
          ...
          <div style="position:relative;z-index:2;">
            <div class="level-badge" style="margin-bottom:16px;font-size:1rem;padding:8px 20px;" id="level-name">DÃƒÆ’Ã‚Â©butant ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â±</div>
            <div style="font-size:4rem;font-weight:800;color:var(--color-white);margin-bottom:4px;" id="total-points">0</div>
            <div style="color:var(--color-text-muted);font-size:0.9rem;margin-bottom:24px;">points accumulÃƒÆ’Ã‚Â©s</div>
        ...
        <div class="section animate-fade-in-up stagger-1">
          <h3 style="margin-bottom:20px;">ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¯ Comment gagner des points</h3>
          <div class="grid grid-3 gap-4">
            <div class="card" style="text-align:center;">
              <div style="font-size:2.5rem;margin-bottom:12px;">ÃƒÂ°Ã…Â¸Ã¢â‚¬Âº'</div>
              <h4 style="font-size:0.95rem;margin-bottom:4px;">Commander</h4>
              <p style="font-size:0.8rem;">+20 pts par commande</p>
            </div>
            <div class="card" style="text-align:center;">
              <div style="font-size:2.5rem;margin-bottom:12px;">Ã¢Ã‚Â­Ã‚Â</div>
              <h4 style="font-size:0.95rem;margin-bottom:4px;">Laisser un avis</h4>
              <p style="font-size:0.8rem;">+10 pts par avis</p>
            </div>
            <div class="card" style="text-align:center;">
              <div style="font-size:2.5rem;margin-bottom:12px;">ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ‚Â¥</div>
        ...
        <div class="section animate-fade-in-up stagger-2">
          <h3 style="margin-bottom:20px;">ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â RÃƒÆ’Ã‚Â©compenses disponibles</h3>
          <div style="display:flex;flex-direction:column;gap:12px;">
            <div class="reward-card">
              <div class="reward-icon">Ã¢Ã‹Å“Ã¢â‚¬Â¢</div>
              <div class="reward-info">
                <h4>CafÃƒÆ’Ã‚Â© offert</h4>
                <p>Un cafÃƒÆ’Ã‚Â© gratuit chez nos partenaires</p>
              </div>
              <div class="reward-cost">100 pts</div>
            </div>
            <div class="reward-card">
              <div class="reward-icon">ÃƒÂ°Ã…Â¸Ã‚Â¥Ã‚Â</div>
              <div class="reward-info">
                <h4>Viennoiserie gratuite</h4>
                <p>Une viennoiserie offerte ÃƒÆ’Ã‚Â  votre prochaine commande</p>
              </div>
              <div class="reward-cost">200 pts</div>
            </div>
            <div class="reward-card">
              <div class="reward-icon">ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â½ÃƒÂ¯Ã‚Â¸Ã‚Â</div>
              <div class="reward-info">
            ...
            <div class="reward-card">
              <div class="reward-icon">ÃƒÂ°Ã…Â¸Ã…Â½Ã¢â‚¬Â°</div>
              <div class="reward-info">
