      ...
      <div class="page-content">
        ...
        <div class="card animate-fade-in-up" style="text-align:center;padding:48px;margin-bottom:32px;position:relative;overflow:hidden;">
          ...
          <div style="position:relative;z-index:2;">
            <div class="level-badge" style="margin-bottom:16px;font-size:1rem;padding:8px 20px;" id="level-name">Débutant <i class="fa-solid fa-house"></i> …' ±</div>
        ...
        <div class="section animate-fade-in-up stagger-1">
          <h3 style="margin-bottom:20px;"><i class="fa-solid fa-house"></i> …Â½ ¯ Comment gagner des points</h3>
          <div class="grid grid-3 gap-4">
            <div class="card" style="text-align:center;">
              <div style="font-size:2.5rem;margin-bottom:12px;"><i class="fa-solid fa-house"></i> €Âº'</div>
            ...
            <div class="card" style="text-align:center;">
              <div style="font-size:2.5rem;margin-bottom:12px;"><i class="fa-solid fa-house"></i> €Ëœ ¥</div>
        ...
        <div class="section animate-fade-in-up stagger-2">
          <h3 style="margin-bottom:20px;"><i class="fa-solid fa-house"></i> …Â½  Récompenses disponibles</h3>
          <div style="display:flex;flex-direction:column;gap:12px;">
            <div class="reward-card">
              <div class="reward-icon">âËœ¢</div>
            ...
            <div class="reward-card">
              <div class="reward-icon"><i class="fa-solid fa-house"></i> …Â½â€°</div>
              <div class="reward-info">
