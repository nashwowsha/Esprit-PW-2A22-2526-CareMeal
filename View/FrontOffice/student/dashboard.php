...
<head>
  ...
  <meta name="description" content="Votre Dashboard CareMeal — Gérez votre profil et vos paramètres.">
  <title>Mon Dashboard — CareMeal</title>
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          <div class="sidebar-section-title">Menu</div>
                    <a href="dashboard.php" class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-chart-line"></i></span> Mon Dashboard</a>
    ...
    <main class="main-content">
      <header class="top-header">
        <div class="header-left">
          ...
          <div class="page-title"><h2>Mon Dashboard</h2><p>Profil, impact et paramètres</p></div>
        </div>
        <div class="header-right">
          ...
          <div class="avatar avatar-sm" id="header-avatar" style="cursor:pointer;" title="Paramètres du compte">AA</div>
        </div>
      </header>
      ...
      <div class="page-content">
        ...
        <div class="profile-header animate-fade-in-up">
          ...
          <div style="margin-left:auto; display:flex; gap:10px;">
            <a href="settings.php" class="btn btn-outline" style="align-self:flex-start;">
