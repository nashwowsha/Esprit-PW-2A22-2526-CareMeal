...
<?php
require_once dirname(__DIR__, 3) . '/Controller/StudentController.php';
...
<head>
  ...
  <style>
    .dashboard-layout .sidebar { background: #ffffff !important; }
  </style>
</head>
<body>
            ...
            <div class="grid grid-3 gap-6" id="offers-grid">
              ...
              <div class="offer-card animate-fade-in-up student-offer-card" data-cat-id="<?= $catId ?>">
                ...
                <div class="offer-card-body">
                  ...
                  <button class="btn btn-primary" style="width:100%;margin-top:12px;" onclick="Student.placeOfferOrder(<?= (int)$o['id_offre'] ?>)">
