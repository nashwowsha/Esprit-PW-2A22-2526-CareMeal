    ...
    <main class="main-content">
      ...
      <div class="page-content">
          ...
          <div class="profile-info">
            ...
            <div class="profile-meta">
              <div class="profile-meta-item">
                <span><i class="fa-solid fa-house"></i> </span> <span id="profile-university">—</span>
              </div>
              <div class="profile-meta-item">
                <span><i class="fa-solid fa-location-dot"></i></span> <span id="profile-quartier">—</span>
              </div>
              <div class="profile-meta-item">
                <span><i class="fa-solid fa-house"></i>...</span> Inscrit le <span id="profile-joined">—</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section animate-fade-in-up stagger-2">
          <div class="section-header">
            <h3><i class="fa-solid fa-house"></i> …'  Votre impact</h3>
          </div>
