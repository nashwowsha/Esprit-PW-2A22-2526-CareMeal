    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          ...
          <a href="<?= htmlspecialchars(caremeal_path('View/FrontOffice/student/dashboard.php'), ENT_QUOTES, 'UTF-8') ?>" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-house"></i></span> Accueil</a>
          <a href="<?= htmlspecialchars(caremeal_path('View/FrontOffice/student/profile.php'), ENT_QUOTES, 'UTF-8') ?>" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-user"></i></span> Mon Profil</a>
          <a href="<?= htmlspecialchars(caremeal_path('View/FrontOffice/student/preferences.php?id_user=' . (int)$idUser), ENT_QUOTES, 'UTF-8') ?>" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-utensils"></i></span> Preferences</a>
          <a href="<?= htmlspecialchars(caremeal_path('View/FrontOffice/student/events.php'), ENT_QUOTES, 'UTF-8') ?>" class="sidebar-link"><span class="link-icon"><i class="fa-solid fa-calendar-day"></i></span> Evenements</a>
          <a href="<?= htmlspecialchars(caremeal_path('View/FrontOffice/student/mes_collectes.php?id_user=' . (int)$idUser), ENT_QUOTES, 'UTF-8') ?>" class="sidebar-link active"><span class="link-icon"><i class="fa-solid fa-box"></i></span> Mes Collectes</a>
        </div>
      </nav>
        ...
        <div class="stack">
          ...
          <section class="card" id="collecte-detail-card">
            <div class="actions" style="justify-content:space-between;">
              ...
              <a class="btn btn-outline btn-sm" href="<?= htmlspecialchars(caremeal_path('View/FrontOffice/student/mes_collectes.php?id_user=' . (int)$idUser), ENT_QUOTES, 'UTF-8') ?>#mes-collectes-section"><i class="fa-solid fa-arrow-left"></i> Retour mes collectes</a>
            </div>
            <?php if (!$detail): ?>
